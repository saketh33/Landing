...
const Card = ({ title, description, color, image, circleBgColor, className = "", delay = 0 }) => (
  <motion.div 
          ...
          <div className="relative mt-8" style={{ height: '460px' }}>
            <div className="absolute left-4 bottom-0 z-10">
              <Card 
                ...
                color="bg-[#C3F53B]"
                image={one} // Use the imported image
            ...
            <div className="absolute left-[300px] bottom-[30px] z-20">
              <Card 
                ...
                color="bg-gray-300"
                image={two} // Use the imported image
            ...
            <div className="absolute left-[600px] bottom-[60px] z-30">
              <Card 
                ...
                color="bg-[#98E5FF]"
                image={three} // Use the imported image
