...
const Card = ({ title, description, color, className = "" }) => (
  <div 
  ...
  >
    ...
    <div className="space-y-4">
      ...
      <div className="mt-6 w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto">
        <img src="/api/placeholder/80/80" alt={title} className="w-16 h-16" />
      </div>
    </div>
  </div>
);
    ...
    <div className="flex items-center justify-center min-h-screen w-full p-4">
      <div className={`relative rounded-2xl border border-gray-800 bg-black w-[1200px] h-[800px] overflow-hidden ${className}`}>
        ...
        <div className="relative h-full w-full p-12">
          <div className="mb-8">
            <div className="inline-block px-4 py-1 bg-black border border-gray-700 rounded-full text-white text-sm mb-4">
              Hooked Vision
            </div>
            <h1 className="text-6xl font-bold text-white italic mb-4">
          ...
          <div className="relative mt-8" style={{ height: '460px' }}>
            <div className="absolute left-4 bottom-0 z-30">
              <Card 
                title="Mission"
                description="Fixing Web3 education dilemma for Web3 massive adoption"
                color="bg-[#C3F53B]"
                className="transform -rotate-6 hover:-translate-y-2 transition-transform"
              />
            </div>
            <div className="absolute left-[260px] bottom-[20px] z-20">
              <Card 
                title="Methodology"
                description="Enabling immersive, gamified, social learning experience"
                color="bg-gray-300"
                className="transform -rotate-3 hover:-translate-y-2 transition-transform"
              />
            </div>
            <div className="absolute left-[520px] bottom-[40px] z-10">
              <Card 
                title="Means"
