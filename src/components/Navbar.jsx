            ...
            <NavigationMenuList className="flex gap-4">
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="group/products relative flex w-auto cursor-pointer items-center gap-2 rounded-full border bg-white p-2 px-6 text-center font-semibold overflow-hidden">
                  ...
                  <span className="relative z-10 ml-3 transition-colors duration-200 group-hover/products:text-white">Products</span>
                </NavigationMenuTrigger>
                <NavigationMenuContent>
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="group/res relative flex w-auto cursor-pointer items-center gap-2 rounded-full border bg-white p-2 px-6 text-center font-semibold overflow-hidden">
                  <div className="absolute left-2 top-1/2 h-2 w-2 -translate-y-1/2 rounded-full bg-black transition-all duration-100 group-hover/res:scale-[100] group-hover/res:bg-black"></div>
                  <span className="relative z-10 ml-3 transition-colors duration-200 group-hover/res:text-white">Resources</span>
                </NavigationMenuTrigger>
                <NavigationMenuContent>
                    ...
                    <div className="grid grid-cols-3 gap-6 p-4">
                      ...
                      <div>
                        <div className="rounded-lg bg-gray-50 p-6">
                          ...
                          <h3 className="mt-4 text-lg font-medium">Quick Setup</h3>
                          <p className="mt-2 text-sm text-gray-500">
                            Get started with your OneKey device in minutes.
                          </p>
                          <a href="/setup" className="mt-4 inline-flex items-center text-sm font-medium text-gray-900 hover:text-gray-600">
